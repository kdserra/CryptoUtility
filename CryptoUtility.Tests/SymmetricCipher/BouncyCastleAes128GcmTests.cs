...
public sealed class BouncyCastleAes128GcmTests : SymmetricCipherAEADTests
{
    ...
    {
        RunBouncyCastleToSystemAadRoundTrip(new CryptoUtility.Aes128GcmImpl(), CipherAEAD);
    }

    [Fact]
    public void Encrypt_SystemDecrypt_BouncyCastleAad_RoundTrip()
    {
        RunSystemToBouncyCastleAadRoundTrip(new CryptoUtility.Aes128GcmImpl(), CipherAEAD);
    }
