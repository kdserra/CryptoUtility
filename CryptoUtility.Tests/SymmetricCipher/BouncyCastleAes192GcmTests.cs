...
public sealed class BouncyCastleAes192GcmTests : SymmetricCipherAEADTests
{
    ...
    {
        RunBouncyCastleToSystemAadRoundTrip(new CryptoUtility.Aes192GcmImpl(), CipherAEAD);
    }

    [Fact]
    public void Encrypt_SystemDecrypt_BouncyCastleAad_RoundTrip()
    {
        RunSystemToBouncyCastleAadRoundTrip(new CryptoUtility.Aes192GcmImpl(), CipherAEAD);
    }
