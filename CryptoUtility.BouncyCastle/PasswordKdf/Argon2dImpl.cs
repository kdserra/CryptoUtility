...
public sealed class Argon2dImpl : Argon2Base
{
    ...
    private Argon2dImpl() : base(Argon2Parameters.Argon2d, defaultIterations: 3, defaultMemoryKb: 65536, defaultParallelism: 4, defaultSaltLength: 16, defaultOutputLength: 32)
    {
    }
}
