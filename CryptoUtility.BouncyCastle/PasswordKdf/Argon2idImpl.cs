...
public sealed class Argon2idImpl : Argon2Base
{
    ...
    private Argon2idImpl() : base(Argon2Parameters.Argon2id, defaultIterations: 3, defaultMemoryKb: 65536, defaultParallelism: 4, defaultSaltLength: 16, defaultOutputLength: 32)
    {
    }
}
