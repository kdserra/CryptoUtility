...
| **Key Derivation**| Official .NET `Hkdf`, `HkdfStandard` (from [HKDF.Standard (backwards compatible)](https://github.com/andreimilto/HKDF.Standard)) | Secure cryptographic key expansion. |
